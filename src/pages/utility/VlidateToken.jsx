        ...
        <>
            ...
            <section className={Style.container}>
                ...
                <div className={Style.codeContainer}>
                    <input
                        ref={(el) => (sixDigitRef.current[0] = el)}
                        maxLength={1}
                        id="0"
                        tabIndex={0}
                    ...
                    />
                    <input
                        ref={(el) => (sixDigitRef.current[1] = el)}
                        maxLength={1}
                        id="1"
                        tabIndex={1}
                        className={Style.codeBox}
                    ...
                    />
                    <input
                        ref={(el) => (sixDigitRef.current[2] = el)}
                        maxLength={1}
                        id="2"
                        tabIndex={2}
                        className={Style.codeBox}
                    ...
                    />
                    <input
                        ref={(el) => (sixDigitRef.current[3] = el)}
                        maxLength={1}
                        id="3"
                        tabIndex={3}
                        className={Style.codeBox}
                    ...
                    />
                    <input
                        ref={(el) => (sixDigitRef.current[4] = el)}
                        maxLength={1}
                        id="4"
                        tabIndex={4}
                        className={Style.codeBox}
                    ...
                    />
                    <input
                        ref={(el) => (sixDigitRef.current[5] = el)}
                        maxLength={1}
                        id="5"
                        tabIndex={5}
                        className={Style.codeBox}
